    ...
    try {
      ...
      for (const db of dbArray) {
        ...
        for (const record of selectResult.recordset) {
          ...
          console.log(`[SAP DB] DocEntry ${record.DocEntry} - DocNum ${record.docnum} | Moneda: ${record.doccur} | DocTotal: ${record.DocTotal} | DocTotalFC: ${record.doctotalfc} | U_Monto_Plazo1: ${record.U_Monto_Plazo1} | U_Monto_Plazo2: ${record.U_Monto_Plazo2} | U_Monto_Plazo3: ${record.U_Monto_Plazo3} | U_CantPlazos: ${record.U_CantPlazos} | SumaPlazos: ${record.SumaPlazos} | Diferencia: ${record.Diferencia} | Campo a ajustar: ${campoActualizar} | Valor actual: ${valorActual} | Nuevo valor: ${nuevoValor}`);
